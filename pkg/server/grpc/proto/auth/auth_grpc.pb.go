...
func (c *authClient) GoogleLogin(ctx context.Context, in *GoogleLoginRequest, opts ...grpc.CallOption) (*GoogleLoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/polls.Auth/GoogleLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/polls.Auth/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/polls.Auth/Register", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_GoogleLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/polls.Auth/GoogleLogin",
	}
...
func _Auth_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/polls.Auth/Register",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/server/grpc/proto/auth.proto",
}
